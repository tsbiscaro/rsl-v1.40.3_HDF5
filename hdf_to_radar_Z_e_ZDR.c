...
#define DEFINED_VOLUMES 2
#define VERSION1_8_0
#define MAX_HDF_STR 255
int return_vartype(char *var)
   {
   char *nome_var[DEFINED_VOLUMES] = {"Z", "ZDR"};
   int vars[DEFINED_VOLUMES] = {CZ_INDEX, DR_INDEX};
   int i;
...
Radar *RSL_hdf5_to_radar(char *infile)
   ...
   int volindx[DEFINED_VOLUMES] = {CZ_INDEX, DR_INDEX};
   ...
   */
   ...
   for (n_volume = 0; n_volume < NVOLUMES; n_volume++)
      ...
      for (n_sweep=0; n_sweep < NSWEEPS; n_sweep++)
         ...
         azim1 = H5Tcreate(H5T_COMPOUND, sizeof(double));
