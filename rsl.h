...
/**********************************************************************/
#ifndef COLORDIR
#define COLORDIR "/usr/local/lib/colors"
#endif
...
/*smooths CAPPIs - remove blank discs between elevations (pseudo-cappi)*/
#define FILL_CAPPI 0
...
typedef struct {
  ...
  char radar_type[52]; /* Type of radar.  Use for QC-ing the data.
	                    * Supported types are:
                        * "wsr88d", "lassen", "uf",
                        * "nsig", "mcgill",
	                    * "kwajalein", "rsl", "toga",
  ...
  char city[16];     /* nearest city to  radar site */
  char state[4];     /* state of radar site */
  char country[16];
